  ...
  return (
    <div className="bg-slate-100 flex">
      ...
      <main className="flex p-4">
        ...
        <Tabs defaultValue="all" className="mb-4">
          <TabsList className="flex space-x-4">
              ...
              <TabsTrigger key={index} value={tab.value} className="rounded-full data-[state=active]:bg-black data-[state=active]:font-bold data-[state=active]:text-white bg-gray-200 px-6 py-2">
                {tab.label}
              </TabsTrigger>
            ))}
          </TabsList>
      ...
      <div className="space-y-6">
        {articles.data.contents.map((article:any) => (
                  ...
                  <Card className="p-4">
                    ...
                    <div className="text-sm">
                      ...
                      <div className='flex gap-10'>
                        ...
                        <div>
                          <span className='text-transparent'>経験職種：</span>
                          <span>プロジェクトマネージャー 28年</span>
                        </div>
                      </div>
                    </div>
                  </Card>
