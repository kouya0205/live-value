...
export default function Page() {
  ...
  const contents: ListItem[] = [
    ...
    {
      content: 'アクセス',
      condition: '【応相談】最低限3ヶ月から／1日3時間から／週2日から　【OK】土日出勤',
    },
    { content: '勤務条件', condition: '渋谷駅　徒歩2分　梅田駅　徒歩5分' },
    { content: '給料', condition: '部署より異なる（交通費：支給なし）' },
    {
      content: '必須・歓迎',
      condition: '【必須】自分なりの精一杯を出し切れる方／チームや顧客のために努力を楽しめる方',
    },
    {
      content: '身につくスキル',
      condition:
        'キャリア支援を行うお仕事のため、就活におけるリテラシーがかなり身に付きます／事業の0→1に携われるため、学べることは自分次第で無限にあります／毎月業務の振り返りを行い、アップデートしていく風土ですので、スキルと自信が身に付きます',
    },
  ];
  ...
  const reviewList: ReviewList[] = [
    {
      title: '株式会社サーキュレーションに内定',
      student: 'XX大学 経済学部 4年生 Aさん',
      satisfaction: '★★★★★',
      review: '検索機能の使いやすさが良かったです',
    },
    {
      title: '株式会社サーキュレーションに内定',
      student: 'XX大学 教育学部 4年生 Bさん',
      satisfaction: '★★★★★',
      review: '企業側と連絡が取りやすかった',
    },
    {
      title: '株式会社サーキュレーションに内定',
      student: 'XX大学 工学部 4年生 Cさん',
      satisfaction: '★★★★★',
      review: '求人が多かった',
    },
    {
      title: '株式会社サーキュレーションに内定',
      student: 'XX大学 医学部 4年生 Dさん',
      satisfaction: '★★★★★',
      review: '自己紹介機能が便利だった',
    },
    {
      title: '株式会社サーキュレーションに内定',
      student: 'XX大学 理学部 4年生 Eさん',
      satisfaction: '★★★★★',
      review: 'サイトが見やすかった',
    },
  ];
        ...
        <div className="w-[800]">
          ...
          <div>
            ...
            <div className="grid grid-cols-6 gap-2 justify-items-start w-[720]">
              <Button className="bg-white text-black rounded-full w-[360] col-start-1 col-sapan-3">
                東京都全域
              </Button>
              <Button className="bg-white text-black rounded-full w-[360] col-start-4 col-sapan-3">
                関西
              </Button>
              <Button className="bg-white text-black rounded-full w-[240] col-start-1 col-sapan-2">
                渋谷
              </Button>
              <Button className="bg-white text-black rounded-full w-[240] col-start-3 col-sapan-2">
                新宿
              </Button>
              <Button className="bg-white text-black rounded-full w-[240] col-start-5 col-sapan-2">
                六本木・港区
              </Button>
              <Button className="bg-white text-black rounded-full w-[240] col-start-1 col-sapan-2">
                東京・丸の内
              ...
              <Button className="bg-white text-black rounded-full w-[720] col-start-1 col-sapan-6">
                東京と関西以外の地方
              </Button>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <Card className="w-[720]">
                ...
                <CardFooter>
                  <div>
                    <Button className="rounded-full bg-white text-gray-400 border-2 h-[48] w-[298]">
                      お気に入り追加
                    </Button>
                  </div>
                  <div>
                    <Button className="rounded-full bg-[#009688] h-[48] w-[298]">
                      このインターンシップを詳しく見る
                    </Button>
                  </div>
                </CardFooter>
